...
const LeaderboardPage = () => {
  ...
  return (
    <section className="w-full h-fit px-5 pt-16 lg:pl-[320px] flex flex-col min-h-screen bg-gradient-to-b from-[#dbebf8] to-[#b0d5ec]">
      {loading ? (
        ...
        <>
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-sm sm:text-xl md:text-2xl">
              Top Bidders and Their Achievements
            </p>
          </div>
              ...
              <tbody className="text-gray-700">
                {leaderboard.slice(0, 10).map((element, index) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-6 font-medium">₹{element.moneySpent}</td>
                    <td className="py-4 px-6 font-medium">{element.auctionsWon}</td>
                  </tr>
                ))}
              </tbody>
            </table>
